...
- New prototypes default to the Midnight palette (deep indigo/navy; canonical source: the private `claude-theme-pack` repo — copy its generated `theme.css` or transcribe from its `tokens.json`).
